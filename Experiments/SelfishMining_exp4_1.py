...
if __name__ == '__main__':
    ...
    # 并行计算
    print("图 1: EBRR = 0")
    getResult(0, 0.02, 0, "../ExperimentData/exp4_1_EBRR0.csv")
    print("图 1: EBRR = 0.0")
    getResult(0.5, 0.02, 0, "../ExperimentData/exp4_1_EBRR1.csv")
    print("图 1: EBRR = 1")
    getResult(1, 0.02, 0, "../ExperimentData/exp4_1_EBRR2.csv")
    print("图 1: EBRR = 1.5")
    getResult(1.5, 0.02, 0, "../ExperimentData/exp4_1_EBRR3.csv")
    print("图 1: EBRR = 2")
    getResult(2, 0.02, 0, "../ExperimentData/exp4_1_EBRR4.csv")

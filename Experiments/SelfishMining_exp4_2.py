...
if __name__ == '__main__':
    ...
    # 并行计算
    print("图 2: EBRR = 0")
    getResult(0, 0.01, 0.01, "../ExperimentData/exp4_2_EBRR0.csv")
    print("图 2: EBRR = 0.5")
    getResult(0.5, 0.01, 0.01, "../ExperimentData/exp4_2_EBRR1.csv")
    print("图 2: EBRR = 1")
    getResult(1, 0.01, 0.01, "../ExperimentData/exp4_2_EBRR2.csv")
    print("图 2: EBRR = 1.5")
    getResult(1.5, 0.01, 0.01, "../ExperimentData/exp4_2_EBRR3.csv")
    print("图 2: EBRR = 2")
    getResult(2, 0.01, 0.01, "../ExperimentData/exp4_2_EBRR4.csv")
